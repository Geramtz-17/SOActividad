...
// Use PropiedadesModel.TipoPropiedad instead of separate import
...
public class PropiedadController {
    ...
    public ResponseEntity<List<PropiedadesModel>> getPropiedadesByTipo(@PathVariable PropiedadesModel.TipoPropiedad tipo){
    ...
    public ResponseEntity<PropiedadesModel> updatePropiedad(@PathVariable Long id, @RequestBody PropiedadesModel propiedadDetails) {
        ...
        if (propiedadOptional.isPresent()) {
            ...
            propiedadToUpdate.setTipoPropiedad(propiedadDetails.getTipoPropiedad());
